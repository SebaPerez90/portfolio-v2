  ...
  const data = [
    {
      ...
      content: (
        ...
        >
          <h2 className="title dark:text-custom-orange text-blue-500 text-3xl lg:text-2xl">
          ...
          <ul className="ml-5 list-disc marker:text-blue-500 dark:marker:text-custom-orange marker:text-lg flex flex-col gap-2 mt-8">
            {(gravitadResponsabilities as Array<string>).map(
              (element, index) => (
                <li
                  className="text-lg lg:text-sm dark:text-slate-100 text-custom-black"
                  key={index}
                >
                  {element}
                </li>
    ...
    },
    {
      ...
      content: (
        <div className="flex relative bottom-14 items-center gap-4 text-blue-500 dark:text-custom-orange">
          <span className="text-9xl lg:text-8xl animate-[loading_1s_linear_infinite]">
            .
          </span>
          <span className="text-9xl lg:text-8xl animate-[loading_1s_linear_infinite] [animation-delay:200ms]">
            .
          </span>
          <span className="text-9xl lg:text-8xl animate-[loading_1s_linear_infinite] [animation-delay:400ms]">
            .
          </span>
        </div>
      ),
